          ...
          <div className="space-y-8">
            ...
            {shops.map((shop) => (
              <div key={shop._id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                {selectedShopId === shop._id && shop.approved && (
                  <div className="mt-6">
                    {/* Management Options */}
                    <div className="mb-6">
                      ...
                      {!shop.approved ? (
                        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                          <div className="flex items-center space-x-2">
                            ...
                            <p className="text-yellow-800 font-medium">This shop is pending admin approval. Management options will be available once approved.</p>
                          </div>
                        </div>
                      ) : (
